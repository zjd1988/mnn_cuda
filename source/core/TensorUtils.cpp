...
DataType TensorUtils::getDataType(const Tensor* tensor)
{
    halide_type_t halide_type = tensor->getType();
    if(halide_type.code == halide_type_float && halide_type.bytes() == 4)
        return DataType_DT_FLOAT;
    else if(halide_type.code == halide_type_float && halide_type.bytes() == 2)
        return DataType_DT_HALF;
    else if(halide_type.code == halide_type_int && halide_type.bytes() == 4)
